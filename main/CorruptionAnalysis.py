...
class CorruptionAnalysis:
    ...
    def _analyze_whole(self):
        ...
        # Store data for metric calculations
    ...
    def _display_results(self, web=False, no_datastore=True):
        ...
        if not web:
            if no_datastore:
                ...
                print(
                    "It appears your submitted XMI already contains a reference to a 'DataSanitizer'. If you wish to have analysis performed, please remove any references to 'DataSanitizer' elements and resubmit your modified XMI to Dubhe.")
